...
public class DialogueManager : MonoBehaviour {
    ...
    /**
    * @pre None.
    * @post Generate the sentences of the event.
    * @para None.   
    **/
    public void Start()
    {
    ...
    /**
     * @pre None.
     * @post Display the sentence in the queue
     * @para None.   
     **/
    ...
    /**
     * @pre None.
     * @post Generate the result of the event depending on the number generated by rolldice()
     * @para None.   
     **/
